...
export function Navbar() {
  return (
    <motion.nav
      ...
      style={{
        background: "var(--glass-strong)", // Adaptável para modo claro/escuro
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--color-brand-500), var(--color-accent-500))", // Púrpura para Magenta
          }}
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <div
          ...
          style={{
            background: "oklch(68% 0.22 148 / 0.1)", // Fundo verde sutil (mantido)
            border: "1px solid oklch(68% 0.22 148 / 0.25)",
            color: "var(--color-success-500)", // Texto verde dinâmico
          }}
        >
          <div
        ...
        <a
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--color-brand-600), var(--color-brand-800))", // Gradiente Púrpura
            boxShadow: "0 4px 14px -2px oklch(58% 0.22 290 / 0.4)", // Sombra puxada pro Púrpura
          }}
        >
